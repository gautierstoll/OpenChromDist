...
Probability distribution based on peaks.  
...
\item 
\mbox{\hyperlink{classPeakBasedDist_a9e56d3c0e4297a4c1f776c3427702fd0}{Peak\+Based\+Dist}} (std\+::string \&\mbox{\hyperlink{classPeakBasedDist_a31c8117337e766c10d8d8b6e7e4bee09}{chromosome}}, unsigned long \mbox{\hyperlink{classPeakBasedDist_a4028fe05cac1967ebd39768c6517e9df}{chr\+Length}}, unsigned long \mbox{\hyperlink{classPeakBasedDist_a6055b04ce2c49fd846ee1eb8c907db96}{bp\+Step}}, unsigned long \mbox{\hyperlink{classPeakBasedDist_a31f64c59a6af28e043f8642c5170dd5b}{wind\+Size}}, const std\+::unordered\+\_\+set$<$ std\+::string $>$ \&\mbox{\hyperlink{classPeakBasedDist_a67bcb2fb67935c3ccabedc4450faac59}{bar\+Code\+Set}})
...
void \mbox{\hyperlink{classPeakBasedDist_ab1cbb045f227193a6eeb6b2ce9bf7f9b}{add\+Peaks\+From\+Frag\+File}} (const std\+::string \&frag\+File, const unsigned long \&wind\+Eval)
\begin{DoxyCompactList}\small\item\em use a fragment tsv file that has chromosome, begin, end, barcode, count \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em set normalization factor as cumulative probability over the whole chromosome \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classPeakBasedDist_afda6689abc313f42024e1814d3b8c424}{write2\+Binary\+File}} (const std\+::string \&bin\+File)
\begin{DoxyCompactList}\small\item\em write object to binary file (without normalization factor) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em static constructor, using binary file (no normalization factor) \end{DoxyCompactList}\item 
static \mbox{\hyperlink{classPeakBasedDist}{Peak\+Based\+Dist}} \mbox{\hyperlink{classPeakBasedDist_acce1090b92329aa9d4f6bc94ed850ddb}{from\+Flat\+File}} (const std\+::string \&chr\+File, const std\+::string \&bar\+Code\+File)
\begin{DoxyCompactList}\small\item\em construct from flat files \end{DoxyCompactList}\item 
static unsigned long \mbox{\hyperlink{classPeakBasedDist_adb5714ee825b17eb4d1cfbb3670bb528}{str\+To\+Uns\+Long}} (const std\+::string \&str)
\end{DoxyCompactItemize}
\doxysubsubsection*{Public Attributes}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classPeakBasedDist_a31c8117337e766c10d8d8b6e7e4bee09}\label{classPeakBasedDist_a31c8117337e766c10d8d8b6e7e4bee09} 
...
\Hypertarget{classPeakBasedDist_a67bcb2fb67935c3ccabedc4450faac59}\label{classPeakBasedDist_a67bcb2fb67935c3ccabedc4450faac59} 
const std\+::unordered\+\_\+set$<$ std\+::string $>$ {\bfseries bar\+Code\+Set}
...
\begin{DoxyCompactList}\small\item\em unnormalized cumulative distribution, for each cells \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em normalization factor, set externally, every prob needs to be divided by it \end{DoxyCompactList}\end{DoxyCompactItemize}
...
The set of values for the unnormalized cumulative probability distribution is given for each bp\+Step (+ the length of the chromosome) \begin{DoxyWarning}{Warning}
The normalization factor can be set, but it is not applied. Every probability should be divided by the normalization factor 
\end{DoxyWarning}


\doxysubsection{Constructor \& Destructor Documentation}
\Hypertarget{classPeakBasedDist_a9e56d3c0e4297a4c1f776c3427702fd0}\label{classPeakBasedDist_a9e56d3c0e4297a4c1f776c3427702fd0} 
\index{PeakBasedDist@{PeakBasedDist}!PeakBasedDist@{PeakBasedDist}}
\index{PeakBasedDist@{PeakBasedDist}!PeakBasedDist@{PeakBasedDist}}
\doxysubsubsection{\texorpdfstring{PeakBasedDist()}{PeakBasedDist()}}
{\footnotesize\ttfamily Peak\+Based\+Dist\+::\+Peak\+Based\+Dist (\begin{DoxyParamCaption}\item[{std\+::string \&}]{chromosome,  }\item[{unsigned long}]{chr\+Length,  }\item[{unsigned long}]{bp\+Step,  }\item[{unsigned long}]{wind\+Size,  }\item[{const std\+::unordered\+\_\+set$<$ std\+::string $>$ \&}]{bar\+Code\+Set }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [explicit]}}
...
\hline
{\em wind\+Size} & sd of gaussian probability density for each peak \\
\hline
...
\hline
\end{DoxyParams}
\Hypertarget{classPeakBasedDist_ab1cbb045f227193a6eeb6b2ce9bf7f9b}\label{classPeakBasedDist_ab1cbb045f227193a6eeb6b2ce9bf7f9b} 
\index{PeakBasedDist@{PeakBasedDist}!addPeaksFromFragFile@{addPeaksFromFragFile}}
\index{addPeaksFromFragFile@{addPeaksFromFragFile}!PeakBasedDist@{PeakBasedDist}}
\doxysubsubsection{\texorpdfstring{addPeaksFromFragFile()}{addPeaksFromFragFile()}}
{\footnotesize\ttfamily void Peak\+Based\+Dist\+::add\+Peaks\+From\+Frag\+File (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{frag\+File,  }\item[{const unsigned long \&}]{wind\+Eval }\end{DoxyParamCaption})}



use a fragment tsv file that has chromosome, begin, end, barcode, count 
...
static constructor, using binary file (no normalization factor) 

\begin{DoxyReturn}{Returns}
a \doxylink{classPeakBasedDist}{Peak\+Based\+Dist} object 
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
normalization factor is not set 
\end{DoxyWarning}
\Hypertarget{classPeakBasedDist_acce1090b92329aa9d4f6bc94ed850ddb}\label{classPeakBasedDist_acce1090b92329aa9d4f6bc94ed850ddb} 
\index{PeakBasedDist@{PeakBasedDist}!fromFlatFile@{fromFlatFile}}
\index{fromFlatFile@{fromFlatFile}!PeakBasedDist@{PeakBasedDist}}
\doxysubsubsection{\texorpdfstring{fromFlatFile()}{fromFlatFile()}}
{\footnotesize\ttfamily \mbox{\hyperlink{classPeakBasedDist}{Peak\+Based\+Dist}} Peak\+Based\+Dist\+::from\+Flat\+File (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{chr\+File,  }\item[{const std\+::string \&}]{bar\+Code\+File }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



construct from flat files 


\begin{DoxyParams}{Parameters}
{\em chr\+File} & chromosome description made of~\newline
 CHROMOSOME=~\newline
 CHRLENGTH=~\newline
 BPSTEP=~\newline
 WINDSIZE=~\newline
 \\
\hline
{\em bar\+Code\+File} & list of barcode separated by newline \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
an empty \doxylink{classPeakBasedDist}{Peak\+Based\+Dist} object @ 
\end{DoxyReturn}
\Hypertarget{classPeakBasedDist_adb5714ee825b17eb4d1cfbb3670bb528}\label{classPeakBasedDist_adb5714ee825b17eb4d1cfbb3670bb528} 
\index{PeakBasedDist@{PeakBasedDist}!strToUnsLong@{strToUnsLong}}
\index{strToUnsLong@{strToUnsLong}!PeakBasedDist@{PeakBasedDist}}
\doxysubsubsection{\texorpdfstring{strToUnsLong()}{strToUnsLong()}}
{\footnotesize\ttfamily static unsigned long Peak\+Based\+Dist\+::str\+To\+Uns\+Long (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{str }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}
...
write object to binary file (without normalization factor) 

binary format is very compact, can only be read within from\+Bin\+File static method 
\begin{DoxyParams}{Parameters}
{\em bin\+File} & \\
\hline
\end{DoxyParams}
\begin{DoxyWarning}{Warning}
normalization factor is not saved 
\end{DoxyWarning}
