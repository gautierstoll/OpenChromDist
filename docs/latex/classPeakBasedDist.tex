...
\begin{DoxyCompactList}\small\item\em use a fragment tsv file that has chormosome, begin, end, barcode, count \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em set normalization factor as (cumul probability over the whole chromosome) \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classPeakBasedDist_afda6689abc313f42024e1814d3b8c424}{write2\+Binary\+File}} (const std\+::string \&bin\+File)
\begin{DoxyCompactList}\small\item\em write object to binary file (missing norm factor) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em static constructor, using binary file (missing norm factor) \end{DoxyCompactList}\item 
...
use a fragment tsv file that has chormosome, begin, end, barcode, count 
...
static constructor, using binary file (missing norm factor) 
...
write object to binary file (missing norm factor) 
