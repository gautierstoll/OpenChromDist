...
\begin{DoxyCompactList}\small\item\em write object to binary file binary format is very compact, can only be read within from\+Bin\+File static method \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em static constructor, using binary file \end{DoxyCompactList}\item 
...
write object to binary file binary format is very compact, can only be read within from\+Bin\+File static method 
