...
\begin{DoxyCompactList}\small\item\em write object to binary file (missing norm factor) binary format is very compact, can only be read within from\+Bin\+File static method \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyParams}{Parameters}
{\em chr\+File} & chromosome description CHROMOSOME= CHRLENGTH= BPSTEP= WINDSIZE= \\
\hline
{\em bar\+Code\+File} & list of barcode separated by ~\newline
\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
write object to binary file (missing norm factor) binary format is very compact, can only be read within from\+Bin\+File static method 
